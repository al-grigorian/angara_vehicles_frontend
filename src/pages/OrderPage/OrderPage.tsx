        ...
        <div className="order-page-wrapper">
            ...
            <div className="order-vehicles-wrapper">
                ...
                <div className="order-info-container">
                    ...
                    {[2, 3, 4].includes(order.status) && <span>Фактическая масса: {order.weight ? order.weight + " тонн" : "Не рассчитано"}</span> }
                    ...
                    {[2, 3, 4].includes(order.status) && <span>Пользователь: {order.owner.name}</span>}
                </div>
